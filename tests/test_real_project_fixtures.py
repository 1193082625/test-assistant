...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "config_default_migration",
            "AssertionError",
            "Expected page size 10, got 20",
            1,
        ),
        (
        ...
        (
            "optional_field_fixture_drift",
            "ValidationError",
            "Input should be a valid string",
            1,
        ),
        (
            "related_config_migration",
            "AssertionError",
            "assert (840, 1040) == (800, 1200)",
            2,
        ),
        (
            "enum_contract_migration",
            "ValidationError",
            "String should match pattern",
            2,
        ),
        (
            "async_mock_result_contract",
            "PytestUnraisableExceptionWarning",
            "was never awaited",
            1,
        ),
        (
            "async_generator_lifecycle",
            "PytestUnraisableExceptionWarning",
            "was never awaited",
            1,
        ),
